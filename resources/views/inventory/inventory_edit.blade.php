...
<main>
    <div class="container-fluid" id="app">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('update-inventory') }}" aria-label="{{ __('Create Inventory') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="item_name" id="" class="form-control" required value="{{ $data['inventory'][0]->item_name }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="item_description" id="" class="form-control" required value="{{ $data['inventory'][0]->item_description }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="item_price" id="" class="form-control" required value="{{ $data['inventory'][0]->item_price }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="quantity" id="" class="form-control" required value="{{ $data['inventory'][0]->quantity }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                          <input id="arrival_date" name="arrival_date" class="form-control{{ $errors->has('arrival_date') ? ' is-invalid' : '' }}" type="date" value="{{ $data['inventory'][0]->arrival_date }}">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                          <input id="expiration_date" name="expiration_date" class="form-control{{ $errors->has('expiration_date') ? ' is-invalid' : '' }}" type="date" value="{{ $data['inventory'][0]->expiration_date }}">
                        </div>
