        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('update-transaction') }}" aria-label="{{ __('Update Transaction') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="transaction_id" value="{{ $data['transaction'][0]->id }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="number" name="doctor_fee" class="form-control" id="doctor_fee" value="{{ $data['transaction'][0]->doctor_fee }}">                           
                        </div>
                    </div>
