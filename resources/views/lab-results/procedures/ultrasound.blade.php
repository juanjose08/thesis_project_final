    ...
    <div class="container-fluid" id="app">
        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                Create Lab Result - Ultrasound
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('save-ultrasound') }}" aria-label="{{ __('Create Lab Result') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <textarea name="impression" class="form-control" id="impression" cols="30" rows="10"></textarea>
                        </div>
                    </div>
